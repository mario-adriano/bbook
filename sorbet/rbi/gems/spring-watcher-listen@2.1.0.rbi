...
module Spring
  class << self
    ...
    # source://spring/4.1.1/lib/spring/commands.rb#19
    def command(name); end

    # source://spring/4.1.1/lib/spring/commands.rb#15
    def command?(name); end

    # source://spring/4.1.1/lib/spring/commands.rb#8
    def commands; end
    ...
    # source://spring/4.1.1/lib/spring/commands.rb#11
